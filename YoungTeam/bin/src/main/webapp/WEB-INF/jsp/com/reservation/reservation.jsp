 ...
 %> <span>원</span>
						...
						<p class="sub_reTxt">
							...
							<br> 결재는 카드결재 또는 계좌이체 가능합니다.<br> <span
								...
								도와드리겠습니다.</span><br> 오늘 날짜로 부터 30일 이내의 날짜만 예약이 가능합니다.<br> <span>※
								자정(밤12시)을 기준으로 예약 가능일이 오픈되며, 목욜은1박 예약만 가능합니다.2박을 선택하면 오늘 날짜로 부터
								31일 째의 날짜를 예약 가능합니다.</span><br> ※ 홈페이지에서 예약취소 및 환불요청을 반드시 하시기
							바랍니다.<br> ※ 한사이트 4명 이용가능하고 5명 부터 (추가금 발생) 최대 6명까지
							이용가능합니다.(영유아 인원 포함입니다)<br> <span style="font-size: 20px;">※
								3시간이내에 결제 하지 않을 시 자동 취소됩니다.</span><br> 당일예약은 1시간이내결재하지 않을시 자동취소
							됩니다.<br> 예약후 <span>예약날짜</span>확인 꼭 당부드립니다.<br> [예약 후 바로
							...
							<div class="click_inner">
								...
								<c:if test="${back eq  '1'}">
									...
									<c:forEach var="i" items="${list }">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'A1' ) or (i.resDate eq resDateEnd and i.sitenum eq 'A1' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'A2' ) or (i.resDate eq resDateEnd and i.sitenum eq 'A2' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'A3' ) or (i.resDate eq resDateEnd and i.sitenum eq 'A3' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'A4' ) or (i.resDate eq resDateEnd and i.sitenum eq 'A4' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'A5' ) or (i.resDate eq resDateEnd and i.sitenum eq 'A5' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'A6' ) or (i.resDate eq resDateEnd and i.sitenum eq 'A6' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'A7' ) or (i.resDate eq resDateEnd and i.sitenum eq 'A7' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'A8' ) or (i.resDate eq resDateEnd and i.sitenum eq 'A8' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'B1' ) or (i.resDate eq resDateEnd and i.sitenum eq 'B1' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'B2' ) or (i.resDate eq resDateEnd and i.sitenum eq 'B2' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'B3' ) or (i.resDate eq resDateEnd and i.sitenum eq 'B3' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'B4' ) or (i.resDate eq resDateEnd and i.sitenum eq 'B4' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'B5' ) or (i.resDate eq resDateEnd and i.sitenum eq 'B5' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'B6' ) or (i.resDate eq resDateEnd and i.sitenum eq 'B6' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'B7' ) or (i.resDate eq resDateEnd and i.sitenum eq 'B7' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'C1' ) or (i.resDate eq resDateEnd and i.sitenum eq 'C1' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'C2' ) or (i.resDate eq resDateEnd and i.sitenum eq 'C2' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'C3' ) or (i.resDate eq resDateEnd and i.sitenum eq 'C3' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'C4' ) or (i.resDate eq resDateEnd and i.sitenum eq 'C4' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'C5' ) or (i.resDate eq resDateEnd and i.sitenum eq 'C5' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'D1' ) or (i.resDate eq resDateEnd and i.sitenum eq 'D1' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'D2' ) or (i.resDate eq resDateEnd and i.sitenum eq 'D2' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'D3' ) or (i.resDate eq resDateEnd and i.sitenum eq 'D3' )}">
										...
										<c:if
											test="${(i.resDate eq resDate and i.sitenum eq 'D4' ) or (i.resDate eq resDateEnd and i.sitenum eq 'D5' )}">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'D5' ) or (i.resDate eq resDateEnd and i.sitenum eq 'D5' )}">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'E1' ) or (i.resDate eq resDateEnd and i.sitenum eq 'E1' )}">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'E2' ) or (i.resDate eq resDateEnd and i.sitenum eq 'E2' )}">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'E3' ) or (i.resDate eq resDateEnd and i.sitenum eq 'E3' )}">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'E4' ) or (i.resDate eq resDateEnd and i.sitenum eq 'E4' )}">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'E5' ) or (i.resDate eq resDateEnd and i.sitenum eq 'E5' )}">
								...
								<c:if test="${back eq '2' }">
									<c:forEach var="i" items="${list }">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'A1' ) or (i.resDate eq resDateMid and i.sitenum eq 'A1' ) or (i.resDate eq resDateEnd and i.sitenum eq 'A1')}">
											<div class="cbtn cbtn_01  cbtn_Pcomplete  " id="A1_site">
												A1 <input type="hidden" class="siteid" value="150">
												<input type="hidden" class="sitetype" value="A"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'A2' ) or (i.resDate eq resDateMid and i.sitenum eq 'A2' ) or (i.resDate eq resDateEnd and i.sitenum eq 'A2')}">
											<div class="cbtn cbtn_02  cbtn_Pcomplete  " id="A2_site">
												A2 <input type="hidden" class="siteid" value="96"> <input
													type="hidden" class="sitetype" value="A"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'A3' ) or (i.resDate eq resDateMid and i.sitenum eq 'A3' ) or (i.resDate eq resDateEnd and i.sitenum eq 'A3')}">
											<div class="cbtn cbtn_03  cbtn_Pcomplete  " id="A3_site">
												A3 <input type="hidden" class="siteid" value="97"> <input
													type="hidden" class="sitetype" value="A"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'A4' ) or (i.resDate eq resDateMid and i.sitenum eq 'A4' ) or (i.resDate eq resDateEnd and i.sitenum eq 'A4')}">
											<div class="cbtn cbtn_04  cbtn_Pcomplete  " id="A4_site">
												A4 <input type="hidden" class="siteid" value="98"> <input
													type="hidden" class="sitetype" value="A"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'A5' ) or (i.resDate eq resDateMid and i.sitenum eq 'A5' ) or (i.resDate eq resDateEnd and i.sitenum eq 'A5')}">
											<div class="cbtn cbtn_05  cbtn_Pcomplete  " id="A5_site">
												A5 <input type="hidden" class="siteid" value="99"> <input
													type="hidden" class="sitetype" value="A"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'A6' ) or (i.resDate eq resDateMid and i.sitenum eq 'A6' ) or (i.resDate eq resDateEnd and i.sitenum eq 'A6')}">
											<div class="cbtn cbtn_06  cbtn_Pcomplete  " id="A6_site">
												A6 <input type="hidden" class="siteid" value="100">
												<input type="hidden" class="sitetype" value="A"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'A7' ) or (i.resDate eq resDateMid and i.sitenum eq 'A7' ) or (i.resDate eq resDateEnd and i.sitenum eq 'A7')}">
											<div class="cbtn cbtn_07  cbtn_Pcomplete  " id="A7_site">
												A7 <input type="hidden" class="siteid" value="101">
												<input type="hidden" class="sitetype" value="A"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'A8' ) or (i.resDate eq resDateMid and i.sitenum eq 'A8' ) or (i.resDate eq resDateEnd and i.sitenum eq 'A8')}">
											<div class="cbtn cbtn_08  cbtn_Pcomplete  " id="A8_site">
												A8 <input type="hidden" class="siteid" value="102">
												<input type="hidden" class="sitetype" value="A"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'B1' ) or (i.resDate eq resDateMid and i.sitenum eq 'B1' ) or (i.resDate eq resDateEnd and i.sitenum eq 'B1')}">
											<div class="cbtn cbtn_09  cbtn_Pcomplete  " id="B1_site">
												B1 <input type="hidden" class="siteid" value="103">
												<input type="hidden" class="sitetype" value="B"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'B2' ) or (i.resDate eq resDateMid and i.sitenum eq 'B2' ) or (i.resDate eq resDateEnd and i.sitenum eq 'B2')}">
											<div class="cbtn cbtn_10  cbtn_Pcomplete  " id="B2_site">
												B2 <input type="hidden" class="siteid" value="104">
												<input type="hidden" class="sitetype" value="B"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'B3' ) or (i.resDate eq resDateMid and i.sitenum eq 'B3' ) or (i.resDate eq resDateEnd and i.sitenum eq 'B3')}">
											<div class="cbtn cbtn_11  cbtn_Pcomplete  " id="B3_site">
												B3 <input type="hidden" class="siteid" value="105">
												<input type="hidden" class="sitetype" value="B"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'B4' ) or (i.resDate eq resDateMid and i.sitenum eq 'B4' ) or (i.resDate eq resDateEnd and i.sitenum eq 'B4')}">
											<div class="cbtn cbtn_12  cbtn_Pcomplete  " id="B4_site">
												B4 <input type="hidden" class="siteid" value="106">
												<input type="hidden" class="sitetype" value="B"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'B5' ) or (i.resDate eq resDateMid and i.sitenum eq 'B5' ) or (i.resDate eq resDateEnd and i.sitenum eq 'B5')}">
											<div class="cbtn cbtn_13  cbtn_Pcomplete  " id="B5_site">
												B5 <input type="hidden" class="siteid" value="107">
												<input type="hidden" class="sitetype" value="B"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'B6' ) or (i.resDate eq resDateMid and i.sitenum eq 'B6' ) or (i.resDate eq resDateEnd and i.sitenum eq 'B6')}">
											<div class="cbtn cbtn_14  cbtn_Pcomplete  " id="B6_site">
												B6 <input type="hidden" class="siteid" value="108">
												<input type="hidden" class="sitetype" value="B"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'B7' ) or (i.resDate eq resDateMid and i.sitenum eq 'B7' ) or (i.resDate eq resDateEnd and i.sitenum eq 'B7')}">
											<div class="cbtn cbtn_15  cbtn_Pcomplete  " id="B7_site">
												B7 <input type="hidden" class="siteid" value="109">
												<input type="hidden" class="sitetype" value="B"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'C1' ) or (i.resDate eq resDateMid and i.sitenum eq 'C1' ) or (i.resDate eq resDateEnd and i.sitenum eq 'C1')}">
											<div class="cbtn cbtn_16  cbtn_Pcomplete  " id="C1_site">
												C1 <input type="hidden" class="siteid" value="110">
												<input type="hidden" class="sitetype" value="C"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'C2' ) or (i.resDate eq resDateMid and i.sitenum eq 'C2' ) or (i.resDate eq resDateEnd and i.sitenum eq 'C2')}">
											<div class="cbtn cbtn_17  cbtn_Pcomplete  " id="C2_site">
												C2 <input type="hidden" class="siteid" value="111">
												<input type="hidden" class="sitetype" value="C"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'C3' ) or (i.resDate eq resDateMid and i.sitenum eq 'C3' ) or (i.resDate eq resDateEnd and i.sitenum eq 'C3')}">
											<div class="cbtn cbtn_18  cbtn_Pcomplete  " id="C3_site">
												C3 <input type="hidden" class="siteid" value="112">
												<input type="hidden" class="sitetype" value="C"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'C4' ) or (i.resDate eq resDateMid and i.sitenum eq 'C4' ) or (i.resDate eq resDateEnd and i.sitenum eq 'C4')}">
											<div class="cbtn cbtn_19  cbtn_Pcomplete  " id="C4_site">
												C4 <input type="hidden" class="siteid" value="113">
												<input type="hidden" class="sitetype" value="C"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'C5' ) or (i.resDate eq resDateMid and i.sitenum eq 'C5' ) or (i.resDate eq resDateEnd and i.sitenum eq 'C5')}">
											<div class="cbtn cbtn_20  cbtn_Pcomplete  " id="C5_site">
												C5 <input type="hidden" class="siteid" value="114">
												<input type="hidden" class="sitetype" value="C"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'D1' ) or (i.resDate eq resDateMid and i.sitenum eq 'D1' ) or (i.resDate eq resDateEnd and i.sitenum eq 'D1')}">
											<div class="cbtn cbtn_21  cbtn_Pcomplete  " id="D1_site">
												D1 <input type="hidden" class="siteid" value="115">
												<input type="hidden" class="sitetype" value="D"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'D2' ) or (i.resDate eq resDateMid and i.sitenum eq 'D2' ) or (i.resDate eq resDateEnd and i.sitenum eq 'D2')}">
											<div class="cbtn cbtn_22  cbtn_Pcomplete  " id="D2_site">
												D2 <input type="hidden" class="siteid" value="116">
												<input type="hidden" class="sitetype" value="D"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'D3' ) or (i.resDate eq resDateMid and i.sitenum eq 'D3' ) or (i.resDate eq resDateEnd and i.sitenum eq 'D3')}">
											<div class="cbtn cbtn_23  cbtn_Pcomplete " id="D3_site">
												D3 <input type="hidden" class="siteid" value="117">
												<input type="hidden" class="sitetype" value="D"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'D4' ) or (i.resDate eq resDateMid and i.sitenum eq 'D4' ) or (i.resDate eq resDateEnd and i.sitenum eq 'D4')}">
											<div class="cbtn cbtn_24  cbtn_Pcomplete  " id="D4_site">
												D4 <input type="hidden" class="siteid" value="118">
												<input type="hidden" class="sitetype" value="D"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'D5' ) or (i.resDate eq resDateMid and i.sitenum eq 'D5' ) or (i.resDate eq resDateEnd and i.sitenum eq 'D5')}">
											<div class="cbtn cbtn_25  cbtn_Pcomplete  " id="D5_site">
												D5 <input type="hidden" class="siteid" value="119">
												<input type="hidden" class="sitetype" value="D"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'E1' ) or (i.resDate eq resDateMid and i.sitenum eq 'E1' ) or (i.resDate eq resDateEnd and i.sitenum eq 'E1')}">
											<div class="cbtn cbtn_26  cbtn_Pcomplete  " id="E1_site">
												E1 <input type="hidden" class="siteid" value="120">
												<input type="hidden" class="sitetype" value="E"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'E2' ) or (i.resDate eq resDateMid and i.sitenum eq 'E2' ) or (i.resDate eq resDateEnd and i.sitenum eq 'E2')}">
											<div class="cbtn cbtn_27  cbtn_Pcomplete  " id="E2_site">
												E2 <input type="hidden" class="siteid" value="121">
												<input type="hidden" class="sitetype" value="E"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'E3' ) or (i.resDate eq resDateMid and i.sitenum eq 'E3' ) or (i.resDate eq resDateEnd and i.sitenum eq 'E3')}">
											<div class="cbtn cbtn_28  cbtn_Pcomplete" id="E3_site">
												E3 <input type="hidden" class="siteid" value="122">
												<input type="hidden" class="sitetype" value="E"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'E4' ) or (i.resDate eq resDateMid and i.sitenum eq 'E4' ) or (i.resDate eq resDateEnd and i.sitenum eq 'E5')}">
											<div class="cbtn cbtn_29  cbtn_Pcomplete" id="E4_site">
												E4 <input type="hidden" class="siteid" value="123">
												<input type="hidden" class="sitetype" value="E"> <input
													type="hidden" class="site_price" value="25000">
										...
										<c:if test="${(i.resDate eq resDate and i.sitenum eq 'E5' ) or (i.resDate eq resDateMid and i.sitenum eq 'E5' ) or (i.resDate eq resDateEnd and i.sitenum eq 'E5')}">
											<div class="cbtn cbtn_30  cbtn_Pcomplete" id="E5_site">
												E5 <input type="hidden" class="siteid" value="124">
												<input type="hidden" class="sitetype" value="E"> <input
													type="hidden" class="site_price" value="25000">
