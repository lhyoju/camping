...
<script>
	function goLogin() {
	    ...
	    document.userForm.action = "/member/login";
	    document.userForm.submit();
	}
	
	//로그인 폼에서 회원가입 폼으로 이동
	function goJoin(){
		opener.location.replace('/member/join'); //부모창 회원가입폼으로 이동
	...
	<div>
		...
		<div class="member_login">
			<form method="POST" action="" accept-charset="UTF-8"
				...
				<div class="id-search">
					<a href="/member/idsearch" ><span class="id-s"></span>아이디 찾기</a>
					<a href="/member/pwdsearch"><span class="pw-s"></span>비밀번호 찾기</a>
